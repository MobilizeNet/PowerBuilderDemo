...
#line 1 "w_employee_maint_updates\\w_employee_maint_updates.cs"
#line hidden
...
#line hidden
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_2"] = _Mobilize_References[7];
            refs["cb_1"] = _Mobilize_References[8];
            refs["dw_1"] = _Mobilize_References[9];
            return refs;
        }
        ...
        const uint _Mobilize_Dirty_cb_2 = (uint)1 << 7;
        const uint _Mobilize_Loaded_cb_2 = (uint)1 << 7;
        const uint _Mobilize_Dirty_cb_1 = (uint)1 << 8;
        const uint _Mobilize_Loaded_cb_1 = (uint)1 << 8;
        const uint _Mobilize_Dirty_dw_1 = (uint)1 << 9;
        const uint _Mobilize_Loaded_dw_1 = (uint)1 << 9;
#line 7
    }
}