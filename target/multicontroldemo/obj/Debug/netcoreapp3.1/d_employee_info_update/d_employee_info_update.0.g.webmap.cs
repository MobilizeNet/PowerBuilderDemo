...
#line 1 "d_employee_info_update\\d_employee_info_update.cs"
#line hidden
...
#line hidden
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["gb_1"] = _Mobilize_References[0];
            refs["tname_t"] = _Mobilize_References[1];
            refs["tname"] = _Mobilize_References[2];
            refs["tdescription"] = _Mobilize_References[3];
            refs["tdepartment_t"] = _Mobilize_References[4];
            refs["tdepartment"] = _Mobilize_References[5];
            refs["thiredate_t"] = _Mobilize_References[6];
            refs["thiredate"] = _Mobilize_References[7];
            refs["tage"] = _Mobilize_References[8];
            refs["tage_t"] = _Mobilize_References[9];
            refs["tsalary_t"] = _Mobilize_References[10];
            refs["tsalary"] = _Mobilize_References[11];
            refs["tcategory_t"] = _Mobilize_References[12];
            refs["tcategory"] = _Mobilize_References[13];
            refs["tlastlogin_t"] = _Mobilize_References[14];
            refs["tlastlogin"] = _Mobilize_References[15];
            refs["tregistered"] = _Mobilize_References[16];
            refs["level"] = _Mobilize_References[17];
            refs["t_1"] = _Mobilize_References[18];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_gb_1 = (Mobilize.WebMap.Common.Core.IObservable)this.gb_1;
            if (ref_gb_1 != null)
        ...
        const uint _Mobilize_Dirty_gb_1 = (uint)1 << 0;
        const uint _Mobilize_Loaded_gb_1 = (uint)1 << 0;
        const uint _Mobilize_Dirty_tname_t = (uint)1 << 1;
        const uint _Mobilize_Loaded_tname_t = (uint)1 << 1;
        const uint _Mobilize_Dirty_tname = (uint)1 << 2;
        const uint _Mobilize_Loaded_tname = (uint)1 << 2;
        const uint _Mobilize_Dirty_tdescription = (uint)1 << 3;
        const uint _Mobilize_Loaded_tdescription = (uint)1 << 3;
        const uint _Mobilize_Dirty_tdepartment_t = (uint)1 << 4;
        const uint _Mobilize_Loaded_tdepartment_t = (uint)1 << 4;
        const uint _Mobilize_Dirty_tdepartment = (uint)1 << 5;
        const uint _Mobilize_Loaded_tdepartment = (uint)1 << 5;
        const uint _Mobilize_Dirty_thiredate_t = (uint)1 << 6;
        const uint _Mobilize_Loaded_thiredate_t = (uint)1 << 6;
        const uint _Mobilize_Dirty_thiredate = (uint)1 << 7;
        const uint _Mobilize_Loaded_thiredate = (uint)1 << 7;
        const uint _Mobilize_Dirty_tage = (uint)1 << 8;
        const uint _Mobilize_Loaded_tage = (uint)1 << 8;
        const uint _Mobilize_Dirty_tage_t = (uint)1 << 9;
        const uint _Mobilize_Loaded_tage_t = (uint)1 << 9;
        const uint _Mobilize_Dirty_tsalary_t = (uint)1 << 10;
        const uint _Mobilize_Loaded_tsalary_t = (uint)1 << 10;
        const uint _Mobilize_Dirty_tsalary = (uint)1 << 11;
        const uint _Mobilize_Loaded_tsalary = (uint)1 << 11;
        const uint _Mobilize_Dirty_tcategory_t = (uint)1 << 12;
        const uint _Mobilize_Loaded_tcategory_t = (uint)1 << 12;
        const uint _Mobilize_Dirty_tcategory = (uint)1 << 13;
        const uint _Mobilize_Loaded_tcategory = (uint)1 << 13;
        const uint _Mobilize_Dirty_tlastlogin_t = (uint)1 << 14;
        const uint _Mobilize_Loaded_tlastlogin_t = (uint)1 << 14;
        const uint _Mobilize_Dirty_tlastlogin = (uint)1 << 15;
        const uint _Mobilize_Loaded_tlastlogin = (uint)1 << 15;
        const uint _Mobilize_Dirty_tregistered = (uint)1 << 16;
        const uint _Mobilize_Loaded_tregistered = (uint)1 << 16;
        const uint _Mobilize_Dirty_level = (uint)1 << 17;
        const uint _Mobilize_Loaded_level = (uint)1 << 17;
        const uint _Mobilize_Dirty_t_1 = (uint)1 << 18;
        const uint _Mobilize_Loaded_t_1 = (uint)1 << 18;
#line 7
    }
}