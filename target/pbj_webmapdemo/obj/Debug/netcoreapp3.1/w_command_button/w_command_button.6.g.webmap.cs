...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_0) > 0)
            {
                yield return "cb_0";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "cb_0":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_0) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_0"] = _Mobilize_References[5];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_cb_0 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cb_0);
            if (ref_cb_0 != null)
                yield return ref_cb_0;
            yield break;
        }
        ...
        const uint _Mobilize_Dirty_cb_0 = (uint)1 << 5;
        const uint _Mobilize_Loaded_cb_0 = (uint)1 << 5;
#line 7
    }
}