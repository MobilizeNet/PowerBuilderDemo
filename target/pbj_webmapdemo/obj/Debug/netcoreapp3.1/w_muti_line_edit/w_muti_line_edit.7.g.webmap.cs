...
#line 1 "w_muti_line_edit\\w_muti_line_edit.cs"
#line hidden
...
#line hidden
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_4"] = _Mobilize_References[0];
            refs["cb_5"] = _Mobilize_References[1];
            refs["cb_6"] = _Mobilize_References[2];
            refs["cb_3"] = _Mobilize_References[3];
            refs["cb_1"] = _Mobilize_References[4];
            refs["cb_7"] = _Mobilize_References[5];
            refs["mle_1"] = _Mobilize_References[6];
            return refs;
        }
        ...
        const uint _Mobilize_Dirty_cb_4 = (uint)1 << 0;
        const uint _Mobilize_Loaded_cb_4 = (uint)1 << 0;
        const uint _Mobilize_Dirty_cb_5 = (uint)1 << 1;
        const uint _Mobilize_Loaded_cb_5 = (uint)1 << 1;
        const uint _Mobilize_Dirty_cb_6 = (uint)1 << 2;
        const uint _Mobilize_Loaded_cb_6 = (uint)1 << 2;
        const uint _Mobilize_Dirty_cb_3 = (uint)1 << 3;
        const uint _Mobilize_Loaded_cb_3 = (uint)1 << 3;
        const uint _Mobilize_Dirty_cb_1 = (uint)1 << 4;
        const uint _Mobilize_Loaded_cb_1 = (uint)1 << 4;
        const uint _Mobilize_Dirty_cb_7 = (uint)1 << 5;
        const uint _Mobilize_Loaded_cb_7 = (uint)1 << 5;
        const uint _Mobilize_Dirty_mle_1 = (uint)1 << 6;
        const uint _Mobilize_Loaded_mle_1 = (uint)1 << 6;
#line 7
    }
}