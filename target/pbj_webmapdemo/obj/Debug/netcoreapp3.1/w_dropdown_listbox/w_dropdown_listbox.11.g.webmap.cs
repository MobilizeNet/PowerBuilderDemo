...
#line 1 "w_dropdown_listbox\\w_dropdown_listbox.cs"
#line hidden
...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_10) > 0)
            {
                yield return "cb_10";
            }
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_ddlb_1) > 0)
            {
                yield return "ddlb_1";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "cb_10":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_10) > 0;
                case "cb_9":
                ...
                case "ddlb_1":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_ddlb_1) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_10"] = _Mobilize_References[1];
            refs["cb_9"] = _Mobilize_References[2];
            refs["cb_8"] = _Mobilize_References[3];
            refs["cb_7"] = _Mobilize_References[4];
            refs["cb_2"] = _Mobilize_References[5];
            refs["cb_4"] = _Mobilize_References[6];
            refs["cb_5"] = _Mobilize_References[7];
            refs["cb_6"] = _Mobilize_References[8];
            refs["cb_1"] = _Mobilize_References[9];
            refs["ddlb_1"] = _Mobilize_References[10];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_cb_10 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cb_10);
            if (ref_cb_10 != null)
                yield return ref_cb_10;
            ...
            var ref_ddlb_1 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.ddlb_1);
            if (ref_ddlb_1 != null)
                yield return ref_ddlb_1;
            yield break;
        }
        ...
        const uint _Mobilize_Dirty_cb_10 = (uint)1 << 1;
        const uint _Mobilize_Loaded_cb_10 = (uint)1 << 1;
        const uint _Mobilize_Dirty_cb_9 = (uint)1 << 2;
        const uint _Mobilize_Loaded_cb_9 = (uint)1 << 2;
        const uint _Mobilize_Dirty_cb_8 = (uint)1 << 3;
        const uint _Mobilize_Loaded_cb_8 = (uint)1 << 3;
        const uint _Mobilize_Dirty_cb_7 = (uint)1 << 4;
        const uint _Mobilize_Loaded_cb_7 = (uint)1 << 4;
        const uint _Mobilize_Dirty_cb_2 = (uint)1 << 5;
        const uint _Mobilize_Loaded_cb_2 = (uint)1 << 5;
        const uint _Mobilize_Dirty_cb_4 = (uint)1 << 6;
        const uint _Mobilize_Loaded_cb_4 = (uint)1 << 6;
        const uint _Mobilize_Dirty_cb_5 = (uint)1 << 7;
        const uint _Mobilize_Loaded_cb_5 = (uint)1 << 7;
        ...
        const uint _Mobilize_Dirty_ddlb_1 = (uint)1 << 10;
        const uint _Mobilize_Loaded_ddlb_1 = (uint)1 << 10;
#line 7
    }
}