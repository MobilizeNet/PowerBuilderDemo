...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_time) > 0)
            {
                yield return "cb_time";
            }

            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_number) > 0)
            {
                yield return "cb_number";
            }
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_em_1) > 0)
            {
                yield return "em_1";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            ...
            {
                case "cb_time":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_time) > 0;
                case "cb_number":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cb_number) > 0;
                case "cb_7":
                ...
                case "em_1":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_em_1) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_time"] = _Mobilize_References[0];
            refs["cb_number"] = _Mobilize_References[1];
            refs["cb_7"] = _Mobilize_References[2];
            refs["cb_8"] = _Mobilize_References[3];
            refs["cb_9"] = _Mobilize_References[4];
            refs["cb_1"] = _Mobilize_References[5];
            refs["cb_3"] = _Mobilize_References[6];
            refs["cb_6"] = _Mobilize_References[7];
            refs["cb_5"] = _Mobilize_References[8];
            refs["cb_4"] = _Mobilize_References[9];
            refs["em_1"] = _Mobilize_References[10];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_cb_time = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cb_time);
            if (ref_cb_time != null)
                yield return ref_cb_time;
            var ref_cb_number = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cb_number);
            if (ref_cb_number != null)
                yield return ref_cb_number;
            ...
            var ref_em_1 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.em_1);
            if (ref_em_1 != null)
                yield return ref_em_1;
            yield break;
        }

        private uint _Mobilize_DirtyFlag_0;
        private uint _Mobilize_LoadedFlag_0;
        const uint _Mobilize_Dirty_cb_time = (uint)1 << 0;
        const uint _Mobilize_Loaded_cb_time = (uint)1 << 0;
        const uint _Mobilize_Dirty_cb_number = (uint)1 << 1;
        const uint _Mobilize_Loaded_cb_number = (uint)1 << 1;
        const uint _Mobilize_Dirty_cb_7 = (uint)1 << 2;
        const uint _Mobilize_Loaded_cb_7 = (uint)1 << 2;
        const uint _Mobilize_Dirty_cb_8 = (uint)1 << 3;
        const uint _Mobilize_Loaded_cb_8 = (uint)1 << 3;
        const uint _Mobilize_Dirty_cb_9 = (uint)1 << 4;
        const uint _Mobilize_Loaded_cb_9 = (uint)1 << 4;
        const uint _Mobilize_Dirty_cb_1 = (uint)1 << 5;
        const uint _Mobilize_Loaded_cb_1 = (uint)1 << 5;
        const uint _Mobilize_Dirty_cb_3 = (uint)1 << 6;
        const uint _Mobilize_Loaded_cb_3 = (uint)1 << 6;
        const uint _Mobilize_Dirty_cb_6 = (uint)1 << 7;
        const uint _Mobilize_Loaded_cb_6 = (uint)1 << 7;
        const uint _Mobilize_Dirty_cb_5 = (uint)1 << 8;
        const uint _Mobilize_Loaded_cb_5 = (uint)1 << 8;
        const uint _Mobilize_Dirty_cb_4 = (uint)1 << 9;
        const uint _Mobilize_Loaded_cb_4 = (uint)1 << 9;
        const uint _Mobilize_Dirty_em_1 = (uint)1 << 10;
        const uint _Mobilize_Loaded_em_1 = (uint)1 << 10;
#line 7
    }
}