...
#line 1 "w_check_box\\w_check_box.cs"
#line hidden
...
#line hidden
        ...
        protected override System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cbx_2) > 0)
            {
                yield return "cbx_2";
            }

            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cbx_1) > 0)
            {
                yield return "cbx_1";
            }
        ...
        protected override bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "cbx_2":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cbx_2) > 0;
                case "cbx_1":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_cbx_1) > 0;
            }
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["cb_7"] = _Mobilize_References[0];
            refs["cb_1"] = _Mobilize_References[1];
            refs["cb_3"] = _Mobilize_References[2];
            refs["cb_6"] = _Mobilize_References[3];
            refs["cb_5"] = _Mobilize_References[4];
            refs["cb_4"] = _Mobilize_References[5];
            refs["cbx_2"] = _Mobilize_References[6];
            refs["cbx_1"] = _Mobilize_References[7];
            return refs;
        }
        ...
        protected override System.Collections.Generic.IEnumerable<Mobilize.WebMap.Common.Core.IObservable> _Mobilize_GetReferences()
        {
            ...
            var ref_cbx_2 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cbx_2);
            if (ref_cbx_2 != null)
                yield return ref_cbx_2;
            var ref_cbx_1 = Mobilize.WebMap.Common.Core.Context.CoreContext.Services.Instrumentation.GetAsObservable(this.cbx_1);
            if (ref_cbx_1 != null)
                yield return ref_cbx_1;
            yield break;
        }

        private uint _Mobilize_DirtyFlag_0;
        private uint _Mobilize_LoadedFlag_0;
        const uint _Mobilize_Dirty_cb_7 = (uint)1 << 0;
        const uint _Mobilize_Loaded_cb_7 = (uint)1 << 0;
        const uint _Mobilize_Dirty_cb_1 = (uint)1 << 1;
        const uint _Mobilize_Loaded_cb_1 = (uint)1 << 1;
        const uint _Mobilize_Dirty_cb_3 = (uint)1 << 2;
        const uint _Mobilize_Loaded_cb_3 = (uint)1 << 2;
        ...
        const uint _Mobilize_Dirty_cbx_2 = (uint)1 << 6;
        const uint _Mobilize_Loaded_cbx_2 = (uint)1 << 6;
        const uint _Mobilize_Dirty_cbx_1 = (uint)1 << 7;
        const uint _Mobilize_Loaded_cbx_1 = (uint)1 << 7;
#line 7
    }
}