...
namespace pbj_webmapdemo
{
   ...
   public partial class dw_brands
...
#line 20
      ...
      : base()
      {
         ...
         this.RetrieveStatement = "PBSELECT( VERSION(400) TABLE(NAME=\"productbrands\" ) COLUMN(NAME=\"productbrands.id\") COLUMN(NAME=\"productbrands.name\")) ";
