namespace multicontroldemo
{
   ...
   public interface Id_employee_info_update_grid
      : Mobilize.Web.IDataManager
   {

      Mobilize.Web.DmText level_t { get; set; }

      Mobilize.Web.DmText tregistered_t { get; set; }

      Mobilize.Web.DmText tname_t { get; set; }

      Mobilize.Web.DmText tage_t { get; set; }

      Mobilize.Web.DmText tdescription_t { get; set; }
