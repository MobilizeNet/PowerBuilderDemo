    ...
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSession(options => 
				{
					options.Cookie.Name = ".AspNetCore.Session-pbj_webmapdemo";
				}
			);
            services.AddAntiforgery(options => 
				{
					options.HeaderName = "pbj_webmapdemo-Xsrf-Header";
					options.FormFieldName = "pbj_webmapdemo-Xsrf-Cookie";
				}
			);
        ...
        private static void AddDesktopCompatibilityPlatform(IServiceCollection services, EntryPoint entryPoint)
        {
            ...
            services.AddScoped<Mobilize.WebMap.Common.DCP.IApplication>((provider) => new pbj_webmapdemo.Application(provider) { EntryPoint = entryPoint });
