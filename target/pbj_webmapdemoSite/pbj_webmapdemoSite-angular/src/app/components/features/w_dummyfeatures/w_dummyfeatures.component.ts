...
@Component({
   selector : "app-w-dummyfeatures",
   templateUrl : "w_dummyfeatures.component.html",
   styleUrls : ["w_dummyfeatures.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["featuresw_dummyfeatures"])
export class WDummyfeaturesComponent extends BaseControlComponent implements OnInit {
