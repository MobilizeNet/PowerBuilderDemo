...
@Component({
   selector : "app-w-datawindow-states",
   templateUrl : "w_datawindow_states.component.html",
   styleUrls : ["w_datawindow_states.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["multicontroldemow_datawindow_states"])
export class WDatawindowStatesComponent extends BaseControlComponent implements OnInit {
