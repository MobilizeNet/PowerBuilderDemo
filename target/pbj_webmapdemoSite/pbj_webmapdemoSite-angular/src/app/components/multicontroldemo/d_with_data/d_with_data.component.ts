...
@Component({
   selector : "app-d_with_data",
   templateUrl : "d_with_data.component.html",
   styleUrls : ["d_with_data.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["multicontroldemod_with_data"])
export class DWithDataComponent extends BaseControlComponent implements OnInit {
