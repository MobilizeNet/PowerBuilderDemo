...
@Component({
   selector : "app-d_dw_control_sampler",
   templateUrl : "d_dw_control_sampler.component.html",
   styleUrls : ["d_dw_control_sampler.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["multicontroldemod_dw_control_sampler"])
export class DDwControlSamplerComponent extends BaseControlComponent implements OnInit {
