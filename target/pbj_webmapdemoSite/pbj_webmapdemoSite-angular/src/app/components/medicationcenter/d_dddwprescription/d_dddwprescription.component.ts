...
@Component({
   selector : "app-d_dddwprescription",
   templateUrl : "d_dddwprescription.component.html",
   styleUrls : ["d_dddwprescription.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["medicationcenterd_dddwprescription"])
export class DDddwprescriptionComponent extends BaseControlComponent implements OnInit {
