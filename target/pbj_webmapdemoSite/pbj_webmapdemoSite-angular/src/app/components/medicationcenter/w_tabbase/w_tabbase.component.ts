...
@Component({
   selector : "app-w-tabbase",
   templateUrl : "w_tabbase.component.html",
   styleUrls : ["w_tabbase.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["medicationcenterw_tabbase"])
export class WTabbaseComponent extends BaseControlComponent implements OnInit {
