...
@Component({
   selector : "app-w-loginbase",
   templateUrl : "w_loginbase.component.html",
   styleUrls : ["w_loginbase.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["medicationcenterw_loginbase"])
export class WLoginbaseComponent extends BaseControlComponent implements OnInit {
