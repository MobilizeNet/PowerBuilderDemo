...
@Component({
   selector : "app-d_removeprescription",
   templateUrl : "d_removeprescription.component.html",
   styleUrls : ["d_removeprescription.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["medicationcenterd_removeprescription"])
export class DRemoveprescriptionComponent extends BaseControlComponent implements OnInit {
