...
@Component({
   selector : "app-w-mdi",
   templateUrl : "w_mdi.component.html",
   styleUrls : ["w_mdi.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["medicationcenterw_mdi"])
export class WMdiComponent extends BaseControlComponent implements OnInit {
