...
@Component({
   selector : "app-w-expressions",
   templateUrl : "w_expressions.component.html",
   styleUrls : ["w_expressions.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["notifycurrentcontrolw_expressions"])
export class WExpressionsComponent extends BaseControlComponent implements OnInit {
