...
@Component({
   selector : "app-d_users",
   templateUrl : "d_users.component.html",
   styleUrls : ["d_users.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["notifycurrentcontrold_users"])
export class DUsersComponent extends BaseControlComponent implements OnInit {
