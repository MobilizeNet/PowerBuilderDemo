...
@Component({
   selector : "app-w-window",
   templateUrl : "w_window.component.html",
   styleUrls : ["w_window.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["notifycurrentcontrolw_window"])
export class WWindowComponent extends BaseControlComponent implements OnInit {
