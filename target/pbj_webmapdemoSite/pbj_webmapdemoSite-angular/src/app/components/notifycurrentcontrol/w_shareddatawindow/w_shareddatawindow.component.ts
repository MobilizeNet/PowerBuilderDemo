...
@Component({
   selector : "app-w-shareddatawindow",
   templateUrl : "w_shareddatawindow.component.html",
   styleUrls : ["w_shareddatawindow.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["notifycurrentcontrolw_shareddatawindow"])
export class WShareddatawindowComponent extends BaseControlComponent implements OnInit {
