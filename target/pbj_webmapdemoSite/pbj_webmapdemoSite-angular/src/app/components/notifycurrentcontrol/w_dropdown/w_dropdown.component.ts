...
@Component({
   ...
   templateUrl : "w_dropdown.component.html",
   styleUrls : ["w_dropdown.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["notifycurrentcontrolw_dropdown"])
export class WDropdownComponent extends BaseControlComponent implements OnInit {
