...
@Component({
   selector : "app-dw_brands",
   templateUrl : "dw_brands.component.html",
   styleUrls : ["dw_brands.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["pbj_webmapdemodw_brands"])
export class DwBrandsComponent extends BaseControlComponent implements OnInit {
   columnTemplates = {
      id : 0,
      name : 1
   };
