...
@Component({
   selector : "app-w-dropdown-listbox",
   templateUrl : "w_dropdown_listbox.component.html",
   styleUrls : ["w_dropdown_listbox.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["pbj_webmapdemow_dropdown_listbox"])
export class WDropdownListboxComponent extends BaseControlComponent implements OnInit {
