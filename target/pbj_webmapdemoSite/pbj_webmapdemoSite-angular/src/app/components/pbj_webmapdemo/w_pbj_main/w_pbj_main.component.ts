...
@Component({
   selector : "app-w-pbj-main",
   templateUrl : "w_pbj_main.component.html",
   styleUrls : ["w_pbj_main.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["pbj_webmapdemow_pbj_main"])
export class WPbjMainComponent extends BaseControlComponent implements OnInit {
