...
@Component({
   selector : "app-w-dummy",
   templateUrl : "w_dummy.component.html",
   styleUrls : ["w_dummy.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["modelsw_dummy"])
export class WDummyComponent extends BaseControlComponent implements OnInit {
