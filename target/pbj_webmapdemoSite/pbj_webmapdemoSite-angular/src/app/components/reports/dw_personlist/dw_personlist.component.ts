...
@Component({
   selector : "app-dw_personlist",
   templateUrl : "dw_personlist.component.html",
   styleUrls : ["dw_personlist.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["reportsdw_personlist"])
export class DwPersonlistComponent extends BaseControlComponent implements OnInit {
