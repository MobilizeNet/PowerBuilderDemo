...
#line 1 "w_main_report\\w_main_report.cs"
#line hidden
namespace reports
{
...
#line hidden
        ...
        protected override Mobilize.WebMap.Common.Core.ReferenceMap _Mobilize_GetReferenceMap(Mobilize.WebMap.Common.Core.ReferenceMap refs)
        {
            ...
            refs["dw_1"] = _Mobilize_References[3];
            return refs;
        }
        ...
        const uint _Mobilize_Dirty_dw_1 = (uint)1 << 3;
        const uint _Mobilize_Loaded_dw_1 = (uint)1 << 3;
#line 7
    }
}